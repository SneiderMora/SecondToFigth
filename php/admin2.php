...
<body class="fondo">
  ...
  <tbody>
    ...
    <tr>
      <th scope="row">1</th>
      <td><?php   $row = mysqli_fetch_Array($Resultado); echo $row["Nombre"] ?></td>
      <td> <a href="Administrador.php?InfoID=<?php echo $row['ID']?>" > <i class='far fa-edit fa-2x editar'></i></i></a> </td>
    ...
    <tr>
      <th scope="row">2</th>
      <td><?php   $row = mysqli_fetch_Array($Resultado); echo $row["Nombre"] ?></td>
      <td><a href="Administrador.php?InfoID=<?php echo $row['ID']?>"> <i class='far fa-edit fa-2x editar'></i></a></td>
