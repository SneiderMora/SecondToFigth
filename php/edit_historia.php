...
<header class="Header container-fluid row col-lg-12 text-center mx-0">
	...
	<section class="col-lg-12 row d-flex justify-content-between p-3 mx-1">
		...
		<div><h5 class="display-5">Historia</h5></div>
...
<section class="Datos col-lg-9">
	...
	<form action="Update2.php" enctype="multipart/form-data" method="post">
		...
		<input type="text" name="Name" value="<?php   $row = mysqli_fetch_Array($Resultado2); echo $row["Titulo"]; ?>">
			<br>
		<h3> <small>Descripción</small></h3>
		<textarea name="Description" rows="8" cols="80"><?php echo $row["Historia"]; ?></textarea>
		<br>
