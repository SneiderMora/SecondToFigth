...
<body class="fondo">
  ...
  <tbody>
    ...
    <tr>
      <th scope="row">1</th>
      <td><?php   $row = mysqli_fetch_Array($Resultado3); echo $row["Nosotros"] ?></td>

      <td> <a href="edit_nosotros.php?InfoID=<?php echo $row['ID']?>" > <i class='far fa-edit fa-2x editar'></i></i></a> </td>
