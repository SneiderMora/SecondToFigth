...
$Sql = "UPDATE nosotros SET Nosotros = '$NombrePersonaje', Descripcion = '$Descripcion' WHERE nosotros . ID = '$ID'";
...
<body class="fondo">
	...
	<section>
        ...
        <h1 class="display-3">La Información ha sido modificada <a href="nosotros.php">Regresar</a></h1>
