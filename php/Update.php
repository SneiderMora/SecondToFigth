...
$TituloCode = $_POST["TitleCode"];
$DescripcionCode = $_POST["DescriptionCode"];
$Photo = $_FILES["Photo"];
...
if ($Photo["error"] == 0) {
    ...
    if ($Photo["type"] == "image/png" || $Photo["type"] == "image/jpeg") {
        ...
        if ($Photo["size"] >= 0) {
          ...
          echo "La entrada se subio Con errores.";
}
...
$Sql = "UPDATE personajes SET Nombre = '$NombrePersonaje', Foto = '$Rout', Descripcion = '$Descripcion', Titulo = '$TituloCode', Codigo = '$DescripcionCode' WHERE personajes . ID = '$ID'";
...
<body class="fondo">
	...
	<div class="User">
		<div class="header2">
			...
			<div class="name">Mateo Callejas Holguín</div>
	...
	<section>
        ...
        <h1 class="display-3">El personaje ha sido editado <a href="Admin2.php">Regresar</a></h1>
