	...
	<section>
		...
		<div class="BIEN">
			<form action="mensaje2.php" method="post">
				<fieldset>
					<legend>Correo para el usuario: <b>  <?php echo $row["nombre_stf"]; ?></b></legend><br>
					<input  type="hidden" name="ident" value="<?php echo $row['ID_stf'];?>">
					<h5 class="No">ASUNTO:</h5>
					<input type="text" name="asunto" placeholder="Example: Opinión"><br><br>
					<h5 class="No">Escriba aquí:</h5>
					<textarea rows="10" cols="40" name="Comen" >
					</textarea><br><br>
